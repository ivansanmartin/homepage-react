    ...
    <>
      <main className='d-flex flex-column align-items-center'>
        <header className='d-flex justify-content-center mt-5'>
            <div className='d-flex title justify-content-center text-light text-align-center fw-bold'>
            <TypeAnimation
                        sequence={[
                          'Iván San Martín Software Analyst',
                          1000,
                          'Backend Developer',
                          1000,
        ...
        <section className='presentation d-flex flex-column align-items-start justify-content-center mt-4 gap-4'>
          ...
          <div className='d-flex align-items-center gap-3 flex-wrap'>
            <a className='btn-contact' href='mailto:ivansanmartin987@gmail.com'>Contact</a>
            <a href="https://github.com/ivansanmartin" target="_blank" className="github text-decoration-none fw-bold"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 48 48">
        ...
        <section className='content fade-in d-flex flex-column align-items-center mt-4' id='outlet-section'>
            <Outlet />
        </section>

        <footer className='d-flex flex-column align-items-center justify-content-center mt-4 gap-4'>
          <p className='text-break text-wrap fst-italic'>
