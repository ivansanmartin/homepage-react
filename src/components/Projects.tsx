...
const Projects = () => {
    ...
    const [project] = useState<Project[]>([
        ...
        },
        {
            ...
            description:
                "A REST API designed for junior developers who want to practice integrating APIs in their applications, both frontend and backend.",
        ...
        },
        {
            ...
            description:
                "A MERN stack application consuming my REST API \"Binary Decimal API\". My first web application using Auth0.",
            ...
            <div className="projects card card-1" key={pro.id}>   
                ...
                <div className="body-card d-flex flex-column text-wrap text-break p-1">
                    <div>
                        ...
                        <p>{pro.description}</p>
                        <div className="techs d-flex mb-4">
                            {
                            pro.technologies.map((tech, index) => (
                                <div key={index} className="tech-icon">
                                    <i dangerouslySetInnerHTML={{ __html: icons[tech as keyof IconMap] }} />
                                </div>
                            ))
                            }
                        </div>
                    </div>
                    <a className="btn-main text-center w-50" href={pro.url} target="_blank">
                        View
                    </a>
                </div>
            </div>
